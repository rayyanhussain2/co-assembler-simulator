...
for i in range(len(input_assembly_codes)):
    input_assembly_codes[i] = input_assembly_codes[i].strip()
    input_assembly_codes[i] = input_assembly_codes[i].replace("\t",' ')
...
if(len(error_indices) == 0):
    ...
    print("Line " + str(error_indices[0][0]) + ": " + error_indices[0][1])
#------------------------------------------------------------------------------
